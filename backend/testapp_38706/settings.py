"""
Django settings for testapp_38706 project.
...
ROOT_URLCONF = 'testapp_38706.urls'
...
WSGI_APPLICATION = 'testapp_38706.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_38706 API",
    "DESCRIPTION": "API documentation for testapp_38706 App",
    "VERSION": "v1",
}
